...
func main() {
	...
	var username string = "Sarthak"//normal string
	...
	//TypeCasting
	var intvar= int(smallFloat) //Here we are converting the float value to int value
	fmt.Println(intvar)
	fmt.Printf("Variable is of type: %T \n",intvar)

	//constants
	const constant string = "This is a constant string"
	fmt.Println(constant)
	fmt.Printf("Variable is of type: %T \n",constant) //there value cant be changed
